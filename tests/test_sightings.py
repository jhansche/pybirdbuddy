...
from birdbuddy.sightings import SightingFinishStrategy, SightingReport, SightingType
...
def test_decode_signed_token():
    ...
    def b64(obj: object) -> str:
        """base64url-encode a JSON-serializable object (or raw bytes)."""
...
def _report(sightings: list[dict], token: object = None) -> SightingReport:
    """Build a SightingReport from sighting dicts and an optional token."""
