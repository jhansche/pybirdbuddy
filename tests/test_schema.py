...
_KNOWN_MISSING = frozenset({"SightingCreateInput", "SightingCreateCheckProgressInput"})
...
def _referenced_types() -> set[str]:
    ...
    types.update(t.value for t in SightingType if t is not SightingType.UNKNOWN)
